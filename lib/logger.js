...
const bLogStream = require('../vendor/blamejs/lib/log-stream');
...
const MAX_LOG_SIZE = 10 * 1024 * 1024;   // 10 MiB per file
...
function _emit(level, msg, data) {
  ...
  if (_initialized) {
    ...
    bLogStream.emit(level, msg, meta);
  }
