...
// zero-dep module so scripts/verify-release.js can require it from
...
const MAX_SYNC_FILE_BYTES = (() => {
  const raw = parseInt(b.safeEnv.readVar('HERMITSTASH_MAX_FILE_BYTES', { type: 'string', default: '' }), 10);
  return (Number.isFinite(raw) && raw > 0) ? raw : DEFAULT_MAX_SYNC_FILE_BYTES;
})();
