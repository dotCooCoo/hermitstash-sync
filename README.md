...
- HermitStash server v1.9.19+ with sync features enabled. v1.9.19 ships blamejs v0.8.43+ which emits 0xE2-magic envelopes; this client (on blamejs v0.18.40) requires that posture. Servers below v1.9.19 still on the 0xE1 envelope are not compatible.
